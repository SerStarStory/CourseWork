...
#define KEYWORDS_RE       ";|<-|\\+|-|\\*|/|%|,|==|!=|:|\\(|\\)|<=|>=|!!|&&|\\|\\||#program|variable|start|stop|exit|continue|end|input|output|if|else|for|to|downto|do|while|repeat|until|goto|integer_4"
...
#define T_DATA_TYPE_0 "integer_4"
