...
public class CWLBinaryActionImpl extends ASTWrapperPsiElement implements CWLBinaryAction {

  public CWLBinaryActionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CWLVisitor visitor) {
    visitor.visitBinaryAction(this);
  }
