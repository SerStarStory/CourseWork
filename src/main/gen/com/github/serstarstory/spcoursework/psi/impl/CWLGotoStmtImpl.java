...
public class CWLGotoStmtImpl extends ASTWrapperPsiElement implements CWLGotoStmt {

  public CWLGotoStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CWLLabelCall getLabelCall() {
    return findNotNullChildByClass(CWLLabelCall.class);
  }
