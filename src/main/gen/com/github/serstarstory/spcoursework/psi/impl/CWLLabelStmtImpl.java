...
public class CWLLabelStmtImpl extends ASTWrapperPsiElement implements CWLLabelStmt {

  public CWLLabelStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CWLLabelDef getLabelDef() {
    return findNotNullChildByClass(CWLLabelDef.class);
  }
