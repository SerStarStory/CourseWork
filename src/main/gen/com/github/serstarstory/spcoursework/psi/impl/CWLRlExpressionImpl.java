...
public class CWLRlExpressionImpl extends ASTWrapperPsiElement implements CWLRlExpression {

  public CWLRlExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CWLVisitor visitor) {
    visitor.visitRlExpression(this);
  }
