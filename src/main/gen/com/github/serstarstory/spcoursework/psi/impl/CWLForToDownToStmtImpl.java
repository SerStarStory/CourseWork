...
public class CWLForToDownToStmtImpl extends ASTWrapperPsiElement implements CWLForToDownToStmt {

  public CWLForToDownToStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CWLVisitor visitor) {
    visitor.visitForToDownToStmt(this);
  }
  ...
  public CWLRlExpression getRlExpression() {
    return findNotNullChildByClass(CWLRlExpression.class);
  }
